<template>
  ...
  >
    ...
    >
      <span class="fw-bold font-26">Recovery your password</span>
      <p class="font-grey-100 font-14 font-medium mb-16 mt-8">
        Type your email or username and we will send you a link to reset your
        password.
      </p>
      <form class="w-75" @submit.prevent="handleLogin">
        ...
        <div v-if="error" class="float-start mt-8">
          <p class="font-red font-14 font-medium">
...
export default {
  ...
  methods: {
    ...
    async handleLogin() {
      ...
      try {
        await this.$axios.post("/api/auth/recovery-password", {
          ...this.user,
  ...
  head() {
    return {
      title: `CookieNetwork - Recovery Password`,
      meta: [
        ...
        {
          property: "og:title",
          content: "CookieNetwork - Recovery Password",
        },
        {
